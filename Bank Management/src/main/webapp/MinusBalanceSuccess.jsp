 <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %> 
    ...
    <head>
        ...
        <title>Balance Deduction Success</title>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="error">
                ...
                <div class="message">
                    <h3>Amount Deducted Successfully!</h3>
                    <p>User new balance is: $<%= request.getParameter("balance") %>
                    </p>
                </div>
                <a href="MinusBalance.jsp">Go Back to Deduct More</a>
            </div>
        </div>

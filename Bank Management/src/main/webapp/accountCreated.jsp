...
<body>
    ...
    <div class="container">
        ...
        <div class="error">
            <img src="images/checkmark.png" alt="Error">
            <h2>Net banking account has been successfully created.</h2>
            <p>Now log in using your username and password to access your account and enjoy our services.</p>
        </div>
    </div>
